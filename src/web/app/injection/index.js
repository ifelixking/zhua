...
(function(){
	const css_global = { color: '#333', fontFamily: 'Microsoft YaHei,SimHei,NSimSun,SimSun,SimHei', fontSize: '12px', lineHeight:'12px', position: 'absolute', left: '0px', top: '0px', fontWeigth: 'normal', zIndex: 9999999999 }
